...
import com.oahgnez.kotlin.ngca.presenter.novel.BooksByRankPresenter
...
class BooksByRankActivity : MvpActivity<BooksByRankContract.IView, BooksByRankPresenter>(), BooksByRankContract.IView {
    override fun showInit(data: RankGenderResults) {
        ...
        val fragments = ArrayList<BooksFragment>()
        fragments.add(BooksFragment.newRankInstance(data.male))
        fragments.add(BooksFragment.newRankInstance(data.female ))
        fragments.add(BooksFragment.newRankInstance(data.picture ))
        fragments.add(BooksFragment.newRankInstance(data.epub ))
    ...
    lateinit var mFragmentsAdapter: BaseFragmentAdapter<BooksFragment>
