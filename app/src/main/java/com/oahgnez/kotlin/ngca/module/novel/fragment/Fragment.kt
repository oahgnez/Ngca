package com.oahgnez.kotlin.ngca.module.novel.fragment
...
import com.oahgnez.kotlin.ngca.module.novel.activity.BooksByCatsActivity
import com.oahgnez.kotlin.ngca.module.novel.activity.BooksByRankActivity
import com.oahgnez.kotlin.ngca.module.novel.adapter.BookInfoAdapter
import com.oahgnez.kotlin.ngca.module.novel.adapter.TagsAdapter
...
import com.oahgnez.kotlin.ngca.module.novel.data.model.RankGender
import com.oahgnez.kotlin.ngca.module.novel.presenter.BooksPresenter
 ...
 */
class Fragment : MvpFragment<BooksContract.IView, BooksPresenter>(), BooksContract.IView {
    companion object {
        ...
        fun newCatInstance(gender: String, cat: String, major: String, minors: ArrayList<String>): Fragment {
        ...
        fun newRankInstance(tags: ArrayList<RankGender>): Fragment {
            val instance = Fragment()
            val bundle = Bundle()
    ...
    override fun createPresenter(): BooksPresenter {
        return if (arguments.getInt(EXTRA_TYPE, TYPE_CAT) == TYPE_CAT) {
            ...
            BooksPresenter(TYPE_RANK, tags = ranks.map { it._id?:"" })
        }
