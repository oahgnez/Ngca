...
data class MinCatsModel(var ok: Boolean,
                        var male: List<MinCatModel>,
                        var female: List<MinCatModel>,
                        var picture: List<MinCatModel>,
                        var press: List<MinCatModel>): Serializable
